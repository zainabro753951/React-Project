...
const Hero = () => {
  ...
  let heroFront = "Frontend Developer";
  return (
    <div className='w-full overflow-hidden md:min-h-[179vh] bg-cover bg-no-repeat  bg-[url("/img/hero.webp")]'>
      <div
        ...
        <div
          ...
          <div className='w-full text-start h-auto bg-white/10 backdrop-blur-md rounded-xl mt-10 xs:p-4 md:p-9'>
            <h3 className='md:text-xl xs:text-md font-semibold pb-3 font-Barlow not-italic'>
