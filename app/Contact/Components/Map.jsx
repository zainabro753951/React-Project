    ...
    <div className='w-full overflow-x-hidden h-screen font-Barlow not-italic grid lg:grid-cols-3 gap-4 px-4 place-items-center text-white py-24 bg-[#0D1320] border-b border-gray-500 bg-[url("/img/hero.webp")] bg-cover bg-center'>
      ...
      {!isLoading && (
        <div className="w-full h-full">
          ...
          <iframe className="w-full h-full" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d28898.192348043136!2d68.51749242197744!3d25.126424331458196!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x394c3f781c0ce35d%3A0xf89f5be8e83b69bd!2sTando%20Muhammad%20Khan%2C%20Sindh%2C%20Pakistan!5e0!3m2!1sen!2s!4v1721301932811!5m2!1sen!2s"   allowfullscreen="" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
      )}
    </div>
