...
export const metadata = {
  title: "Strength - Skills & Blogs | Frontend Development Expertise",
  description:
    "Discover the strengths of a frontend developer through detailed skill sets and insightful blogs. Explore expertise in HTML, CSS, Tailwind, Bootstrap, JavaScript.",
};
