...
const AboutHero = () => {
  ...
  return (
    <div
      id="about"
      className="w-full overflow-x-hidden text-white relative pt-32 pb-16 border-b border-gray-500 min-h-screen not-italic font-Barlow bg-cover bg-no-repeat bg-center md:px-[11%] bg-[url('/img/About/Ahero.webp')] grid lg:grid-cols-2 xs:grid-cols-1 xs:px-5"
    >
      <div
        id="about-imgs"
      ...
      <div id="about-hero" className="z-40 w-full h-full md:mt-0 xs:mt-16">
        ...
        <div className="w-full mb-8 bg-white/10 backdrop-blur-md border border-gray-600 xs:rounded-xl md:rounded-r-xl xs:px-4 md:pl-16 py-4">
          ...
          <p className="text-gray-300 text-sm">
            ...
            crafting extraordinary web experiences. My expertise includes HTML,
            CSS, JavaScript, Tailwind CSS, React.js, and GSAP.
            <br />
            <br />
            I'm a frontend development virtuoso with a passion for building web
            applications that dazzle and delight. With a rock-solid foundation
            in HTML, CSS, and JavaScript, I create fast, responsive, and
            interactive experiences that leave a lasting impression.
            <br />
            ...
            expectations. And with GSAP, I bring motion design to life, crafting
            animations that mesmerize and engage.
            <br />
            I'm a design-centric developer who thrives on collaboration and
            creative problem-solving. Whether it's a personal project or a team
            effort, I'm always pushing the boundaries of what's possible on the
            web. Let's join forces and create something truly remarkable!
          </p>
        </div>
